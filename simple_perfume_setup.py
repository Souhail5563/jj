"""
Script simple pour créer des parfums avec les champs existants
"""
import os
...
def setup_perfumes():
    """Créer des parfums avec les champs existants"""
    with app.app_context():
        print("🌸 Configuration simple pour les parfums...")
        ...
        # Créer des parfums avec les nouveaux champs
        perfumes = [
            {
            ...
            },
            {
                ...
                'description': 'Un parfum gourmand et floral qui célèbre la joie de vivre.',
                'price': 76.90,
                'category': 'Eau de Parfum',
                'brand': 'Lancôme',
                'volume': 50,
            ...
            },
            {
                ...
                'description': 'Un parfum aquatique frais et méditerranéen.',
                'price': 69.90,
                'category': 'Eau de Toilette',
                ...
                'heart_notes': 'Jasmin, Calone, Freesia',
...
def main():
    """Fonction principale"""
    print("🌸 Configuration simple du site de parfums")
    print("=" * 50)
